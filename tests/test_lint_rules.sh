...
mkdir -p "$MOCK_VAULT/raw/transcripts"
mkdir -p "$MOCK_VAULT/raw/transcripts/meetings"
mkdir -p "$MOCK_VAULT/raw/transcripts/youtube"
mkdir -p "$MOCK_VAULT/raw/transcripts/podcasts"
